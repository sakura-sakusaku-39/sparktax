...
export const EXPENSE_CATEGORIES: ExpenseCategoryMeta[] = [
  { id: "beauty_a", label: "美容A", description: "ヘア・メイク・ネイル", color: "#FF8FA3", emoji: "💄" },
  { id: "beauty_b", label: "美容B", description: "脱毛・エステ・スキンケア", color: "#FFB199", emoji: "✂️" },
  { id: "costume", label: "衣装", description: "ドレス・下着・小物", color: "#C792EA", emoji: "👗" },
  { id: "transport", label: "交通費", description: "タクシー・電車・送迎", color: "#82C7FF", emoji: "🚕" },
  { id: "gift", label: "贈答・接待", description: "プレゼント・差し入れ", color: "#7FE3D4", emoji: "🎁" },
  { id: "communication", label: "通信費", description: "携帯・ネット", color: "#FFD66B", emoji: "📱" },
  { id: "supplies", label: "備品", description: "仕事の道具", color: "#A0C4FF", emoji: "🛠️" },
  { id: "other", label: "その他", description: "上記以外の業務関連", color: "#9FA8B7", emoji: "🏷️" },
];
